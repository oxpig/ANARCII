...
class ModelRunner:
    ...
    def __init__(self, sequence_type, mode, batch_size, device, verbose, return_logits):
    ...
    def _predict_numbering(self, dl):
        ...
        with torch.no_grad():
            for X in dl:
                ...
                ## Logit mask reveals integers and insertions (X)
                logit_mask = (
                ...
                ## Integer mask reveals only integers
                integer_mask = logit_mask & (max_input != x_token)
